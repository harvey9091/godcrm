...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-[18px] border border-soft bg-gradient-to-b from-obsidian-soft to-stone-black-2 shadow-stone group",
        className
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-lg font-semibold text-text-primary py-2",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm font-normal text-text-secondary max-w-sm",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-[15rem] md:h-[20rem] rounded-[18px] z-40",
        className,
        showGradient &&
          "bg-input-bg [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        `h-16 w-16 rounded-full flex items-center justify-center bg-input-bg
    shadow-[0px_0px_8px_0px_rgba(200,162,95,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]
    `,
        className
      )}
    >
